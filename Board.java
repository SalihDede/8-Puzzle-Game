...
public class Board {
   ...
   private static final double lineThickness = 0.001;
   ...
   public Board() {
      ...
      //----------------ADDED PART--------------------------
      twoDimArray = twoDimArrayConverter(numbers); //call array convertor and assign it.
      //----------------------------------------------------- 
   ...
   public void draw() {
      ...
      for (int row = 0; row < 3; row++)
         for (int col = 0; col < 3; col++) {
            ...
            tiles[row][col].draw(tilePosition.x , tilePosition.y);//BURAAAAAAAAAAAAAAAAAAAAa
